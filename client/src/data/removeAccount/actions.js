...
export const WAITING = 'data/removeAccount/WAITING';
export const SUCCESS = 'data/removeAccount/SUCCESS';
export const FAILURE = 'data/removeAccount/FAILURE';
  ...
  return (dispatch) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!apiKey || apiKey === '') {
        ...
        return fetch(`${config.HOST}/api/client/remove`, {
          method: 'POST',
          headers: {
